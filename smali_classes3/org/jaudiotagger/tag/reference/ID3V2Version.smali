...
.method static constructor <clinit>()V
    ...
    const-string v2, "ID3_V23"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3}, Lorg/jaudiotagger/tag/reference/ID3V2Version;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lorg/jaudiotagger/tag/reference/ID3V2Version;->ID3_V23:Lorg/jaudiotagger/tag/reference/ID3V2Version;

    .line 10
    new-instance v2, Lorg/jaudiotagger/tag/reference/ID3V2Version;

    const-string v3, "ID3_V24"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4}, Lorg/jaudiotagger/tag/reference/ID3V2Version;-><init>(Ljava/lang/String;I)V

    sput-object v2, Lorg/jaudiotagger/tag/reference/ID3V2Version;->ID3_V24:Lorg/jaudiotagger/tag/reference/ID3V2Version;

    .line 6
    filled-new-array {v0, v1, v2}, [Lorg/jaudiotagger/tag/reference/ID3V2Version;
