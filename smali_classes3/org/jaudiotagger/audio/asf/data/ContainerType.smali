...
.method static constructor <clinit>()V
    ...
    .line 19
    filled-new-array {v9, v0, v1, v2, v3}, [Lorg/jaudiotagger/audio/asf/data/ContainerType;
...
.method public static getOrdered()[Lorg/jaudiotagger/audio/asf/data/ContainerType;
    ...
    sget-object v3, Lorg/jaudiotagger/audio/asf/data/ContainerType;->METADATA_OBJECT:Lorg/jaudiotagger/audio/asf/data/ContainerType;

    sget-object v4, Lorg/jaudiotagger/audio/asf/data/ContainerType;->METADATA_LIBRARY_OBJECT:Lorg/jaudiotagger/audio/asf/data/ContainerType;

    filled-new-array {v0, v1, v2, v3, v4}, [Lorg/jaudiotagger/audio/asf/data/ContainerType;
...
.method public checkConstraints(Ljava/lang/String;[BIII)Ljava/lang/RuntimeException;
    ...
    invoke-virtual {p0, v1, v2}, Lorg/jaudiotagger/audio/asf/data/ContainerType;->isWithinValueRange(J)Z
    ...
    sget-object p1, Lorg/jaudiotagger/logging/ErrorMessage;->WMA_LENGTH_OF_DATA_IS_TOO_LARGE:Lorg/jaudiotagger/logging/ErrorMessage;
    ...
    invoke-virtual {v2}, Lorg/jaudiotagger/audio/asf/data/GUID;->getDescription()Ljava/lang/String;
    ...
    .line 218
    invoke-virtual {p1, p2}, Lorg/jaudiotagger/logging/ErrorMessage;->getMsg([Ljava/lang/Object;)Ljava/lang/String;
    ...
    filled-new-array {p4, v0, v3}, [Ljava/lang/Object;

    move-result-object p4

    .line 227
    invoke-virtual {v2, p4}, Lorg/jaudiotagger/logging/ErrorMessage;->getMsg([Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p4

    invoke-direct {v1, p4}, Ljava/lang/IllegalArgumentException;-><init>(Ljava/lang/String;)V
    ...
    .line 234
    invoke-virtual {v1}, Lorg/jaudiotagger/audio/asf/data/GUID;->getDescription()Ljava/lang/String;
    ...
    .line 233
    invoke-virtual {p4, v1}, Lorg/jaudiotagger/logging/ErrorMessage;->getMsg([Ljava/lang/Object;)Ljava/lang/String;
    ...
    const-string p1, "0 to 126"

    .line 240
    :cond_a
    new-instance v0, Ljava/lang/IllegalArgumentException;

    sget-object p2, Lorg/jaudiotagger/logging/ErrorMessage;->WMA_INVALID_LANGUAGE_USE:Lorg/jaudiotagger/logging/ErrorMessage;
    ...
    .line 241
    invoke-virtual {p2, p1}, Lorg/jaudiotagger/logging/ErrorMessage;->getMsg([Ljava/lang/Object;)Ljava/lang/String;
