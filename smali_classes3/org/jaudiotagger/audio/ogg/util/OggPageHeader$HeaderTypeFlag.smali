...
.method static constructor <clinit>()V
    ...
    const-string v2, "CONTINUED_PACKET"

    const/4 v3, 0x1

    invoke-direct {v1, v2, v3, v3}, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;-><init>(Ljava/lang/String;IB)V
    ...
    .line 390
    new-instance v2, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;

    const-string v3, "START_OF_BITSTREAM"

    const/4 v4, 0x2

    invoke-direct {v2, v3, v4, v4}, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;-><init>(Ljava/lang/String;IB)V

    sput-object v2, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;->START_OF_BITSTREAM:Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;
    ...
    const-string v6, "END_OF_BITSTREAM"

    invoke-direct {v3, v6, v4, v5}, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;-><init>(Ljava/lang/String;IB)V

    sput-object v3, Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;->END_OF_BITSTREAM:Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;

    .line 386
    filled-new-array {v0, v1, v2, v3}, [Lorg/jaudiotagger/audio/ogg/util/OggPageHeader$HeaderTypeFlag;
