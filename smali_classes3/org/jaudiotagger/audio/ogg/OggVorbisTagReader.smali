...
.method public readOggVorbisHeaderSizes(Ljava/io/RandomAccessFile;)Lorg/jaudiotagger/audio/ogg/OggVorbisTagReader$OggVorbisHeaderSizes;
    ...
    invoke-virtual {v13, v6}, Ljava/util/logging/Logger;->config(Ljava/lang/String;)V
    ...
    const-string v7, "Found start of vorbis setup header at file position:"

    const-string v9, "finishes at:"

    const-string v13, "Found end of setupheader:size:"

    const-string v10, " to setup header size"
    ...
    invoke-virtual {v11, v7}, Ljava/util/logging/Logger;->fine(Ljava/lang/String;)V
    ...
    invoke-virtual {v5, v7}, Ljava/util/logging/Logger;->config(Ljava/lang/String;)V
    ...
    .line 524
    invoke-virtual {v0, v12}, Lorg/jaudiotagger/audio/ogg/OggVorbisTagReader;->isVorbisSetupHeader([B)Z
    ...
    invoke-interface {v8, v11, v5}, Ljava/util/List;->subList(II)Ljava/util/List;
